...
exports.getCheckoutSession = catchAsync(async (req, res, next) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    mode: "payment",
    success_url: `${req.protocol}://${req.get("host")}/?tour=${req.params.tourId}&user=${req.user.id}&price=${tour.price}`, // This the url that is getting called once the credit card payment is successful which means the user will be
